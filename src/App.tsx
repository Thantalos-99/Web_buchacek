...
export default function App() {
  return (
    <div className="bg-white min-h-screen font-mono scroll-smooth pt-24">
      ...
      <section id="služby" className="min-h-screen flex items-center justify-center bg-gray-100">
        <h2 className="text-3xl font-bold">SLUŽBY</h2>
      </section>

      <section id="vizualizace" className="min-h-screen flex items-center justify-center bg-white">
        <h2 className="text-3xl font-bold">VIZUALIZACE</h2>
      </section>

      <section id="galerie" className="min-h-screen flex items-center justify-center bg-gray-100">
        <h2 className="text-3xl font-bold">GALERIE</h2>
      </section>

      <section id="o_nás" className="min-h-screen flex items-center justify-center bg-white">
